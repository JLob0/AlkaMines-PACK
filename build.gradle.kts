...
dependencies {
    ...
    // NOVO: ProtocolLib para entidades fake client-side (pacotes visuais). 5.4.0 e a
    // versao que adiciona suporte a 1.21.4-1.21.8 (o alvo do projeto). Desde 5.4.0 e
    // publicado no Maven Central sob o groupId net.dmulloy2 (o package de codigo
    // continua com.comphenix.protocol.*). compileOnly: o jar real vem do servidor.
    compileOnly("net.dmulloy2:ProtocolLib:5.4.0")

    // NOVO: Caffeine para cache O(1) de blocos de mina (lookups massivos da habilidade).
